...
const qrs_module_1 = require("./components/qrs/qrs.module");
const logs_module_1 = require("./components/logs/logs.module");
const user_module_1 = require("./components/userLogin/user.module");
